...
\subsection{Langages de programmation et logiciels}\label{def-tools}
...
Toutes les approches utilisées sont basées sur l'apprentissage automatique, supervisé et non supervisé. 
    ...
    Après avoir explicité la liste des mots par cluster, ci-dessous, nous allons présenter les résultats de l'évaluation du modèle \emph{LDA} présenté dans la \autoref{lda-present}.
    \begin{table}[H]
        \begin{center}
            \begin{tabular}{|c|c|}
                \hline
